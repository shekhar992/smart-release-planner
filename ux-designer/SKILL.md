...
Words ARE the interface. Every label, message, and instruction is a design
decision that directly impacts usability.

### Button Labels
- Use verbs that describe the outcome: "Save changes" not "Submit"
- Be specific: "Delete account" not "Continue"
- Primary action label should match the dialog title
- Destructive actions: name what's being destroyed ("Delete 3 files")
...
- Explain what will appear here and why it's empty
- Provide the action to fill it ("Create your first project")
- Show an example or illustration of what it looks like populated
- Search with no results: suggest corrections, show popular items

### Confirmation Dialogs
- Title: the action being confirmed ("Delete this project?")
- Body: the consequence ("This permanently removes all files and data")
- Primary action: matches the title verb ("Delete project")
- Safe exit: positive framing ("Keep project" not "Cancel")
- Critical actions: require typing the name for confirmation

### Tone Matching
- **Errors:** calm, helpful, never blame the user
- **Success:** warm, brief, point to next step
- **Onboarding:** encouraging, not condescending
- **Destructive:** serious, clear about consequences
